...
CATEGORY_TAXONOMY = {
    '뷰티': ['스킨케어(로션/크림)', '세럼/앰플', '클렌징', '선케어', '마스크팩', '메이크업', '헤어/바디', '향수', '뷰티기기', '네일', '기타'],
    '식품': ['반찬/밀키트', '정육/수산', '과일/농산물', '간식/디저트', '음료/커피', '냉동/간편식', '김치/장류', '곡물/견과', '오일/조미료', '유제품/버터/계란', '기타'],
    '영양제': ['비타민/종합', '유산균', '홍삼', '오메가3', '콜라겐', '관절/눈/간', '미네랄', '효소/발효', '즙/시럽/홍삼', '수면/스트레스', '혈행/항산화', '기타'],
    ...
    '살림/청소': ['수납/정리', '세탁/세제', '청소용품', '욕실', '방향/탈취·제습', '휴지/생활소모품', '구강/위생', '기타'],
    '주방': ['냄비/프라이팬', '밀폐용기', '칼/도마', '식기/컵', '텀블러/물병', '주방가전', '베이킹', '세제/소모품', '기타'],
    '가전/디지털': ['생활가전', '계절가전', '음향기기', '모바일 액세서리', 'PC/주변기기', '프린터', '기타'],
    '인테리어': ['침구/패브릭', '커튼/블라인드', '러그', '조명', '가구', '홈데코', '디퓨저/캔들', '식물/원예', '기타'],
